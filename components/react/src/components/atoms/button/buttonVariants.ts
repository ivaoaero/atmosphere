...
export const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-fuselage-700 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-fuselage-550',
  {
    variants: {
      variant: {
        primary:
